...
# ---------------------------------------------------------
# 2. Googleフォーム自動配付用設定（誤配付防止機能）
# ---------------------------------------------------------
# ★ご自身のGoogleフォームの情報をここに設定します
FORM_ID = "1FAIpQLSe0E6C8Q3eqMsW_WLXRN6vYAFJn97RoqixZuJrXiDh4FsFThA"  # 例: 1FAIpQLSc... のようなフォームID
...
if include_1st:
    try:
        sheet_id = "11ATTRKkKY5Qeue6GYA2l3_Pjfmy44KOR5hbLddtDp7s"
